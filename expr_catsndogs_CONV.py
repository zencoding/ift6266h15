...
l0_filter_shape=(32, l0_n_in[1], 11, 11)
...
) + LinearLayer(512, 128, npy_rng=npy_rng
) + ReluLayer(128, 512, npy_rng=npy_rng
) + LinearLayer(512, 128, npy_rng=npy_rng
...
for epoch in xrange(finetune_epc):
    ...
    try:
        if epoch % 30 == 0:
            save_params(model, 'CONV_11-5-3-3_32-48-64-128_3332_512-128-512-128-10.npy')
    except:
        pass
